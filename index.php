...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        if (isset($_FILES['archivo'])) {
            foreach ($_FILES['archivo']['name'] as $index => $nombreArchivo) {
                $archivoTmp = $_FILES['archivo']['tmp_name'][$index];
                move_uploaded_file($archivoTmp, $carpetaRuta . '/' . $nombreArchivo);
            }
            $subido = true;
    ...
    <div class="content">
        ...
        <div class="container" id="container">
            <div class="drop-area" id="drop-area">
                <form action="" id="form" method="POST" enctype="multipart/form-data" onsubmit="uploadFile(event)">
                    ...
                    <input type="file" class="file-input" name="archivo[]" id="archivo" multiple onchange="uploadFile(event); document.getElementById('form').submit()">
            ...
            <div class="container2">
                ...
                <div id="file-list" class="pila">
                    ...
                    <form method="POST">
                        <button type="submit" name="descargarTodo" class="Btn">Descargar Todo (ZIP)</button>
                    </form>
                    <form method="POST">
                        <button type="submit" name="eliminarTodo" class="Btn">Eliminar Todo</button>
                    </form>
            </div>
